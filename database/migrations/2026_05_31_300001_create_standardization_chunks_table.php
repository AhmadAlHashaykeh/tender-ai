...
return new class extends Migration
{
    ...
    {
        Schema::create('standardization_chunks', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedInteger('auto_approved_rows')->default(0);
    ...
    {
        Schema::dropIfExists('standardization_chunks');
    }
};
